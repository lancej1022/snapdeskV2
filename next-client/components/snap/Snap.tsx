...
const Snap: React.FC<Props> = ({ idStyle, updateRating, index }) => (
  <div className="snap-rating" onClick={() => updateRating(index)}>
    ...
    >
      <path
        d="M51.5,43.8V10.5C51.5,9.7,52.2,9,53,9s1.5,0.7,1.5,1.5v33.3c0,0.8-0.7,1.5-1.5,1.5
      C52.2,45.2,51.5,44.6,51.5,43.8z"
      />
      <path
        d="M59.5,47.3c0.5,0,0.9-0.2,1.2-0.6l16-20.9c0.2-0.3,0.3-0.7,0.3-1.1c-0.1-0.4-0.2-0.7-0.6-1
        c-0.3-0.2-0.6-0.3-0.9-0.3c-0.5,0-0.9,0.2-1.2,0.6l-16,21c-0.5,0.6-0.4,1.6,0.3,2C58.8,47.2,59.2,47.3,59.5,47.3z"
      />
      <path
        d="M45.3,46.8c0.3,0.4,0.7,0.6,1.2,0.6c0.3,0,0.6-0.1,0.9-0.3c0.3-0.2,0.5-0.6,0.6-1s-0.1-0.8-0.3-1.1l-16-20.9
        c-0.3-0.4-0.7-0.6-1.2-0.6c-0.3,0-0.6,0.1-0.9,0.3c-0.6,0.5-0.8,1.4-0.3,2L45.3,46.8z"
      />
      <path
        d="M92.4,109.5c1.2,4.1-0.2,8.7-3.7,11.6c-11.8,9.7-22.3,16.9-38,22.3l-9.8,8.8c-0.5,0.5-1.2,0.8-2,0.8l0,0v-0.8
